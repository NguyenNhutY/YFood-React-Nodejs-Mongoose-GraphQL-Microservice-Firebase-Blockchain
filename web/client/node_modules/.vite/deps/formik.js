...
var FormikContext = Q(void 0);
FormikContext.displayName = "FormikContext";
var FormikProvider = FormikContext.Provider;
var FormikConsumer = FormikContext.Consumer;
function useFormikContext() {
  var formik = x2(FormikContext);
...
function useFormik(_ref) {
  ...
  var initialValues = A(props.initialValues);
  var initialErrors = A(props.initialErrors || emptyErrors);
  var initialTouched = A(props.initialTouched || emptyTouched);
  var initialStatus = A(props.initialStatus);
  ...
  var _React$useState = d(0), setIteration = _React$useState[1];
  var stateRef = A({
  ...
  var dispatch = q(function(action) {
    var prev = stateRef.current;
    stateRef.current = formikReducer(prev, action);
    if (prev !== stateRef.current) setIteration(function(x3) {
      return x3 + 1;
    });
  }, []);
  var runValidateHandler = q(function(values, field) {
  ...
  var runValidationSchema = q(function(values, field) {
  ...
  var runSingleFieldLevelValidation = q(function(field, value) {
    return new Promise(function(resolve) {
      return resolve(fieldRegistry.current[field].validate(value));
    });
  }, []);
  var runFieldLevelValidations = q(function(values) {
  ...
  var runAllValidations = q(function(values) {
  ...
  var resetForm = q(function(nextState) {
  ...
  var registerField = q(function(name, _ref3) {
    var validate = _ref3.validate;
    fieldRegistry.current[name] = {
      validate
    };
  }, []);
  var unregisterField = q(function(name) {
  ...
  var setErrors = q(function(errors) {
    dispatch({
      type: "SET_ERRORS",
      payload: errors
    });
  ...
  var setFieldError = q(function(field, value) {
    dispatch({
      type: "SET_FIELD_ERROR",
      payload: {
        field,
  ...
  var executeChange = q(function(eventOrTextValue, maybePath) {
    var field = maybePath;
  ...
  var executeBlur = q(function(e, path) {
    if (e.persist) {
      e.persist();
    }
  ...
  var setFormikState = q(function(stateOrCb) {
  ...
  var setStatus = q(function(status) {
    dispatch({
      type: "SET_STATUS",
      payload: status
    });
  }, []);
  var setSubmitting = q(function(isSubmitting) {
    dispatch({
  ...
  var getFieldMeta = q(function(name) {
    return {
  ...
  var getFieldHelpers = q(function(name) {
    return {
  ...
  var getFieldProps = q(function(nameOrOptions) {
...
function Formik(props) {
  ...
  return _(FormikProvider, {
    value: formikbag
  }, component ? _(component, formikbag) : render ? render(formikbag) : children ? isFunction2(children) ? children(formikbag) : !isEmptyChildren(children) ? O.only(children) : null : null);
}
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? _2 : y;
...
function Field(_ref) {
  ...
  if (typeof asElement === "string") {
    ...
    return _(asElement, _extends({
      ref: _innerRef
    }, field, _rest, {
      className
    }), children);
  }
  return _(asElement, _extends({}, field, props, {
    className
  }), children);
}
var Form = D(function(props, ref) {
  var action = props.action, rest = _objectWithoutPropertiesLoose(props, ["action"]);
  var _action = action != null ? action : "#";
  var _useFormikContext = useFormikContext(), handleReset = _useFormikContext.handleReset, handleSubmit = _useFormikContext.handleSubmit;
  return _("form", _extends({
    ...
    var C = (function(_React$Component) {
      ...
      function C2() {
        ...
        _this.renderFormComponent = function(formikProps) {
          return _(Component$1, _extends({}, _this.props, formikProps));
        };
        return _this;
      }
      ...
      _proto.render = function render() {
        ...
        return _(Formik, _extends({}, props, config, {
...
function connect(Comp) {
  var C = function C2(props) {
    return _(FormikConsumer, null, function(formik) {
...
var FieldArrayInner = (function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return component ? _(component, props) : render2 ? render2(props) : children ? typeof children === "function" ? children(props) : !isEmptyChildren(children) ? O.only(children) : null : null;
  };
...
var ErrorMessageImpl = (function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return !!touch && !!error ? render2 ? isFunction2(render2) ? render2(error) : null : children ? isFunction2(children) ? children(error) : null : component ? _(component, rest, error) : error : null;
  };
...
var FastFieldInner = (function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return _(asElement, _extends({}, field, props), children);
  };
