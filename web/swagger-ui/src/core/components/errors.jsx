...
export default class Errors extends React.Component {
  ...
  render() {
    ...
    return (
      <pre class="errors-wrapper">
        <hgroup class="error">
          <h4 class="errors__title">Errors</h4>
          <button class="btn errors__clear-btn" onClick={ toggleVisibility }>{ isVisible ? "Hide" : "Show" }</button>
        </hgroup>
    ...
    <div class="error-wrapper">
      { !error ? null :
        <div>
          ...
          <span class="message">{ error.get("message") }</span>
          <div class="error-line">
            { jumpToLine ? (
